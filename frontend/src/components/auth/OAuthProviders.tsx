...
// Individual OAuth provider components for more granular control
export const GoogleOAuthButton: React.FC<{
  ...
  <Button
    ...
    loading={loading}
    disabled={disabled}
    className={`w-full hover:bg-blue-50 dark:hover:bg-blue-900/20 border-blue-200 dark:border-blue-800 ${className}`}
    icon={<Chrome />}
  >
...
export const GitHubOAuthButton: React.FC<{
  ...
  <Button
    ...
    loading={loading}
    disabled={disabled}
    className={`w-full hover:bg-gray-50 dark:hover:bg-gray-800 border-gray-200 dark:border-gray-700 ${className}`}
    icon={<Github />}
  >
